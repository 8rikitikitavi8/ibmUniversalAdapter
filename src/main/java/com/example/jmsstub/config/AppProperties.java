...
public class AppProperties {
	...
	public static class Broker {
		public enum Vendor { ACTIVEMQ }

		private String id;
		private Vendor vendor = Vendor.ACTIVEMQ;
		private String url;
	...
	public static class Route {
		...
		public String getListenBrokerId() {
			return listenBrokerId;
		}

		public void setListenBrokerId(String listenBrokerId) {
			this.listenBrokerId = listenBrokerId;
		}
		...
		public String getReplyBrokerId() {
			return replyBrokerId;
		}

		public void setReplyBrokerId(String replyBrokerId) {
			this.replyBrokerId = replyBrokerId;
		}
